    ...
    <section id="como-funciona" className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  >
                    <div
                      ...
                      style={{
                        ...
                        boxShadow: `0 0 0 0 ${paso.color}00`,
                      }}
                    >
        ...
        <motion.div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(255,0,122,0.08), rgba(155,0,255,0.08))',
        ...
        >
          ...
          <a
            href="https://wa.me/51999999999?text=Hola%2C+tengo+algunas+dudas+antes+de+reservar."
            target="_blank"
